	<div class="row margin0">
		...
		<div class="col-md-10 col-xs-12">
			<div style="" class="switch">
		    	...
		    	<div class="btnadmin">
		    		<a href="#" class="btn btnchange-<?php echo $field['name'] ?>" type="button"><?php echo alang("EDIT_INFO") ?></a>
		    	</div>
		    	<div class="btnadmin">
		    		<a href="#" class="btn btndelete-<?php echo $field['name'] ?>" type="button"><?php echo alang("DELETE") ?></a>
		    	</div>
		  	</div>
		</div>
	</div>
