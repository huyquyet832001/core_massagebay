...
<div id="Breadcrumb" class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom">
    ...
    <ul>
        ...
        <li class="SecondLast"><a href="Techsystem/editRobot"><?php echo alang("ROBOT") ?></a></li>
   ...
   <div class="widget row margin0">
      ...
      <div class="widget-title">
         ...
         <h4>
            ...
            <i class="icon-qrcode"></i>&nbsp; <?php echo alang("ROBOT") ?>
      ...
      <div class="widget-body">
        ...
        <form action="Techsystem/editRobot" method="post" id="savefile">
