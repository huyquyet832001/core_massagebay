    ...
    this.getHtmlItem = function(id,src,name,item){
    	...
    	var html = `<li class="col-sm-3 col-xs-12 gallery-item">
                 <div>
                    ...
                    <p>`+name+`</p>
                    <i class="icon-remove gallery-close"></i> <a href="Techsystem/Media/media?istiny=`+id+`&callback=GALLERY_CONTROL_ADMIN_PROVIDER.callback" class="iframe-btn button" type="button">Chọn hình</a> 
                 </div>
              </li>`;
        return html;
    }
